...
if(dset == 'synthetic'):
    ...
    builtins.keras_model_fn = MyPerceptronKeras
...
_, state, train_metrics, test_metrics = run_fl(
    rng,
    dataset,
    preprocess,
...
train_losses, train_index = train_metrics
test_losses, test_index = test_metrics
train_d = {'train_losses':train_losses, 'train_index':train_index}
test_d = {'test_losses':test_losses, 'test_index':test_index}
